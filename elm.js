...
Elm.Index.make = function (_elm) {
   ...
   var Nothing = {ctor: "Nothing"};
   var model = 0;
   return _elm.Index.values = {_op: _op,model: model,Nothing: Nothing,update: update,view: view};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var main = $StartApp$Simple.start({model: $Index.model,view: $Index.view,update: $Index.update});
